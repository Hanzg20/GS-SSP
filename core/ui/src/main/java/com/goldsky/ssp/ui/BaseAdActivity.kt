 ...
 * If there is no interaction for 3 minutes, it launches the AdActivity.
 */
abstract class BaseAdActivity : AppCompatActivity() {
    ...
    // Inactivity timeout in milliseconds (3 minutes)
    private val inactivityTimeoutMs: Long = 180000
